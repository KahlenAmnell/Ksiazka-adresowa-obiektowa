...
int AdresatMenager::wylogowanieUzytkownika(int idZalogowanegoUzytkownika)
{
    adresaci.clear();
...
int AdresatMenager::dodajAdresata(int idZalogowanegoUzytkownika, int idOstatniegoAdresata)
{
    Adresat adresat;
